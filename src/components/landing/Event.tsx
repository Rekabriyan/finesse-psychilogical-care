      ...
      >
        ...
        <div className="container mx-auto px-6 md:px-16 relative z-10 pt-16 md:pt-0">
          ...
          >
            ...
            >
              Get the latest information about our workshops, webinars, and
              community events. Stay informed about mental health awareness
              programs and exclusive sessions with our professionals.
            </motion.p>
